    ...
    <el-card class="config-card" shadow="hover">
      ...
      <div class="config-grid">
        ...
        <div class="config-item" v-if="data.tlsForce">
          <span class="config-label">强制TLS</span>
